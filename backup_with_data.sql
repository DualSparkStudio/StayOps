...
\restrict L5ajc09a5zkiVanV2CfyEEoVUp9hkgMc9pboujNhxMqAwxfU4fIyRvzXOdnTJzV
...
DROP POLICY IF EXISTS "Allow authenticated update" ON public.features;
DROP POLICY IF EXISTS "Allow authenticated update" ON public.attractions;
DROP POLICY IF EXISTS "Allow authenticated insert" ON public.features;
DROP POLICY IF EXISTS "Allow authenticated insert" ON public.attractions;
DROP POLICY IF EXISTS "Allow authenticated delete" ON public.features;
DROP POLICY IF EXISTS "Allow authenticated delete" ON public.attractions;
ALTER TABLE IF EXISTS ONLY storage.vector_indexes DROP CONSTRAINT IF EXISTS vector_indexes_bucket_id_fkey;
ALTER TABLE IF EXISTS ONLY storage.s3_multipart_uploads_parts DROP CONSTRAINT IF EXISTS s3_multipart_uploads_parts_upload_id_fkey;
ALTER TABLE IF EXISTS ONLY storage.s3_multipart_uploads_parts DROP CONSTRAINT IF EXISTS s3_multipart_uploads_parts_bucket_id_fkey;
ALTER TABLE IF EXISTS ONLY storage.s3_multipart_uploads DROP CONSTRAINT IF EXISTS s3_multipart_uploads_bucket_id_fkey;
ALTER TABLE IF EXISTS ONLY storage.objects DROP CONSTRAINT IF EXISTS "objects_bucketId_fkey";
ALTER TABLE IF EXISTS ONLY public.whatsapp_sessions DROP CONSTRAINT IF EXISTS whatsapp_sessions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.whatsapp_messages DROP CONSTRAINT IF EXISTS whatsapp_messages_session_id_fkey;
...
DROP INDEX IF EXISTS public.idx_whatsapp_sessions_guest_phone;
DROP INDEX IF EXISTS public.idx_whatsapp_messages_session_id;
DROP INDEX IF EXISTS public.idx_whatsapp_messages_is_read;
...
DROP INDEX IF EXISTS public.idx_tourist_attractions_is_featured;
DROP INDEX IF EXISTS public.idx_tourist_attractions_is_active;
DROP INDEX IF EXISTS public.idx_tourist_attractions_display_order;
DROP INDEX IF EXISTS public.idx_tourist_attractions_category;
...
DROP INDEX IF EXISTS public.idx_social_media_links_is_active;
DROP INDEX IF EXISTS public.idx_social_media_links_display_order;
DROP INDEX IF EXISTS public.idx_rooms_slug;
DROP INDEX IF EXISTS public.idx_rooms_room_number;
DROP INDEX IF EXISTS public.idx_rooms_quantity;
DROP INDEX IF EXISTS public.idx_rooms_is_available;
DROP INDEX IF EXISTS public.idx_rooms_is_active;
DROP INDEX IF EXISTS public.idx_rooms_deleted;
DROP INDEX IF EXISTS public.idx_room_images_room_id;
DROP INDEX IF EXISTS public.idx_room_images_is_primary;
DROP INDEX IF EXISTS public.idx_resort_closures_start_date;
DROP INDEX IF EXISTS public.idx_resort_closures_is_active;
DROP INDEX IF EXISTS public.idx_resort_closures_end_date;
DROP INDEX IF EXISTS public.idx_house_rules_order_num;
DROP INDEX IF EXISTS public.idx_house_rules_is_active;
DROP INDEX IF EXISTS public.idx_features_is_active;
DROP INDEX IF EXISTS public.idx_features_display_order;
DROP INDEX IF EXISTS public.idx_facilities_is_active;
DROP INDEX IF EXISTS public.idx_contact_messages_is_read;
DROP INDEX IF EXISTS public.idx_contact_messages_email;
DROP INDEX IF EXISTS public.idx_contact_messages_created_at;
DROP INDEX IF EXISTS public.idx_calendar_settings_key;
DROP INDEX IF EXISTS public.idx_bookings_room_id;
DROP INDEX IF EXISTS public.idx_bookings_razorpay_order_id;
DROP INDEX IF EXISTS public.idx_bookings_payment_status;
DROP INDEX IF EXISTS public.idx_bookings_email;
DROP INDEX IF EXISTS public.idx_bookings_check_out_date;
DROP INDEX IF EXISTS public.idx_bookings_check_in_date;
DROP INDEX IF EXISTS public.idx_bookings_booking_status;
DROP INDEX IF EXISTS public.idx_bookings_booking_source;
DROP INDEX IF EXISTS public.idx_blocked_dates_start_date;
DROP INDEX IF EXISTS public.idx_blocked_dates_source;
DROP INDEX IF EXISTS public.idx_blocked_dates_room_id;
DROP INDEX IF EXISTS public.idx_blocked_dates_external_id;
DROP INDEX IF EXISTS public.idx_blocked_dates_end_date;
DROP INDEX IF EXISTS public.idx_attractions_is_active;
DROP INDEX IF EXISTS public.idx_attractions_category;
...
ALTER TABLE IF EXISTS ONLY public.tourist_attractions DROP CONSTRAINT IF EXISTS tourist_attractions_pkey;
ALTER TABLE IF EXISTS ONLY public.testimonials DROP CONSTRAINT IF EXISTS testimonials_pkey;
ALTER TABLE IF EXISTS ONLY public.social_media_links DROP CONSTRAINT IF EXISTS social_media_links_pkey;
ALTER TABLE IF EXISTS ONLY public.rooms DROP CONSTRAINT IF EXISTS rooms_slug_key;
...
ALTER TABLE IF EXISTS ONLY public.resort_closures DROP CONSTRAINT IF EXISTS resort_closures_pkey;
ALTER TABLE IF EXISTS ONLY public.house_rules DROP CONSTRAINT IF EXISTS house_rules_pkey;
...
ALTER TABLE IF EXISTS ONLY public.calendar_settings DROP CONSTRAINT IF EXISTS calendar_settings_setting_key_key;
...
ALTER TABLE IF EXISTS ONLY public.attractions DROP CONSTRAINT IF EXISTS attractions_pkey;
...
ALTER TABLE IF EXISTS public.tourist_attractions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.testimonials ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.social_media_links ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.rooms ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.room_images ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.resort_closures ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.house_rules ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.calendar_settings ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.attractions ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.whatsapp_sessions_id_seq;
...
DROP SEQUENCE IF EXISTS public.tourist_attractions_id_seq;
DROP TABLE IF EXISTS public.tourist_attractions;
DROP SEQUENCE IF EXISTS public.testimonials_id_seq;
DROP TABLE IF EXISTS public.testimonials;
DROP SEQUENCE IF EXISTS public.social_media_links_id_seq;
DROP TABLE IF EXISTS public.social_media_links;
DROP SEQUENCE IF EXISTS public.rooms_id_seq;
DROP TABLE IF EXISTS public.rooms;
DROP SEQUENCE IF EXISTS public.room_images_id_seq;
DROP TABLE IF EXISTS public.room_images;
DROP SEQUENCE IF EXISTS public.resort_closures_id_seq;
DROP TABLE IF EXISTS public.resort_closures;
DROP SEQUENCE IF EXISTS public.house_rules_id_seq;
DROP TABLE IF EXISTS public.house_rules;
...
DROP SEQUENCE IF EXISTS public.calendar_settings_id_seq;
...
DROP SEQUENCE IF EXISTS public.attractions_id_seq;
...
--
-- Name: TABLE attractions; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN attractions.images; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN attractions.travel_time; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN attractions.highlights; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN attractions.best_time; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN blocked_dates.source; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN blocked_dates.external_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN blocked_dates.platform_data; Type: COMMENT; Schema: public; Owner: -
--
...
CREATE TABLE public.bookings (
    ...
    room_name text,
    CONSTRAINT bookings_booking_status_check CHECK (((booking_status)::text = ANY (ARRAY[('pending'::character varying)::text, ('confirmed'::character varying)::text, ('cancelled'::character varying)::text]))),
    CONSTRAINT bookings_payment_gateway_check CHECK (((payment_gateway)::text = ANY (ARRAY[('direct'::character varying)::text, ('razorpay'::character varying)::text]))),
    CONSTRAINT bookings_payment_status_check CHECK (((payment_status)::text = ANY (ARRAY[('pending'::character varying)::text, ('paid'::character varying)::text, ('failed'::character varying)::text]))),
    CONSTRAINT check_dates_valid CHECK ((check_out_date > check_in_date))
);


--
-- Name: COLUMN bookings.num_extra_adults; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN bookings.num_children_above_5; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN bookings.subtotal_amount; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN bookings.gst_amount; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN bookings.gst_percentage; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: house_rules; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: resort_closures; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: resort_closures_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: resort_closures_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: COLUMN rooms.check_in_time; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN rooms.check_out_time; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN rooms.price_double_occupancy; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN rooms.price_triple_occupancy; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN rooms.price_four_occupancy; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN rooms.extra_mattress_price; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN rooms.quantity; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN rooms.child_above_5_price; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN rooms.gst_percentage; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN rooms.deleted_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN rooms.is_deleted; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN rooms.max_capacity; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: social_media_links; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: social_media_links_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: social_media_links_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.testimonials (
    ...
    CONSTRAINT testimonials_source_check CHECK (((source)::text = ANY (ARRAY[('website'::character varying)::text, ('google'::character varying)::text])))
);
...
--
-- Name: tourist_attractions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.whatsapp_messages (
    ...
    is_read boolean DEFAULT false,
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT whatsapp_messages_message_type_check CHECK (((message_type)::text = ANY (ARRAY[('text'::character varying)::text, ('image'::character varying)::text, ('file'::character varying)::text, ('location'::character varying)::text]))),
    CONSTRAINT whatsapp_messages_sender_type_check CHECK (((sender_type)::text = ANY (ARRAY[('guest'::character varying)::text, ('admin'::character varying)::text])))
);
...
CREATE TABLE public.whatsapp_sessions (
    ...
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT whatsapp_sessions_session_status_check CHECK (((session_status)::text = ANY (ARRAY[('active'::character varying)::text, ('closed'::character varying)::text, ('archived'::character varying)::text])))
);
...
--
-- Name: house_rules id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: resort_closures id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: room_images id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: social_media_links id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: tourist_attractions id; Type: DEFAULT; Schema: public; Owner: -
--
...
COPY public.bookings (id, room_id, check_in_date, check_out_date, num_guests, first_name, last_name, email, phone, special_requests, total_amount, booking_status, payment_status, payment_gateway, razorpay_order_id, razorpay_payment_id, booking_source, created_at, updated_at, num_extra_adults, num_children_above_5, subtotal_amount, gst_amount, gst_percentage, room_name) FROM stdin;
26	5	2026-02-22	2026-02-27	2	Sahil	dhanawade	jaydhanawade4848@gmail.com	8983784848		25200.00	confirmed	paid	razorpay	order_SJ8AwIRJ56RroP	pay_SJ8BJvjdfP43da	website	2026-02-22 08:48:36.498237+00	2026-02-28 05:25:05.284834+00	0	0	22500.00	2700.00	12.00	Valley Room
27	3	2026-02-22	2026-02-23	6	Sahil	dhanawade	jaydhanawade4848@gmail.com	8983784848		12320.00	confirmed	paid	razorpay	order_SJ8DNe5WrFA0AV	pay_SJ8DYKjgD1S9Lp	website	2026-02-22 08:50:49.442424+00	2026-02-28 05:25:05.284834+00	2	2	11000.00	1320.00	12.00	Family Room
28	3	2026-02-23	2026-02-24	8	Sahil	dhanawade	jaydhanawade4848@gmail.com	8983784848		14000.00	confirmed	paid	razorpay	order_SJ8G0z0JoDasb4	pay_SJ8G9v0CEJvxF0	website	2026-02-22 08:53:11.368922+00	2026-02-28 05:25:05.284834+00	1	5	12500.00	1500.00	12.00	Family Room
29	3	2026-02-24	2026-02-27	8	Sahil	dhanawade	jaydhanawade4848@gmail.com	8983784848		47040.00	confirmed	paid	razorpay	order_SJ8HJkhWD0tnv6	pay_SJ8HTe04WNEoYQ	website	2026-02-22 08:54:27.432844+00	2026-02-28 05:25:05.284834+00	4	2	42000.00	5040.00	12.00	Family Room
30	3	2026-02-27	2026-02-28	2	Sahil	dhanawade	jaydhanawade4848@gmail.com	8983784848		6720.00	confirmed	paid	razorpay	order_SJ8IDyVzL4Bgz0	pay_SJ8IMEpAVDG519	website	2026-02-22 08:55:16.298919+00	2026-02-28 05:25:05.284834+00	0	0	6000.00	720.00	12.00	Family Room
31	4	2026-02-22	2026-02-23	2	Yash	Karanjule	yashkaranjule230@gmail.com	9604269875		3920.00	confirmed	paid	razorpay	order_SJ8OwWBbe0MmzK	pay_SJ8P3xbPJmJbez	website	2026-02-22 09:01:37.012992+00	2026-02-28 05:25:05.284834+00	0	0	3500.00	420.00	12.00	Deulex room
32	4	2026-02-22	2026-02-23	2	Sahil	dhanawade	jaydhanawade4848@gmail.com	8983784848		3920.00	confirmed	paid	razorpay	order_SJ8QmgQ8by7LfP	pay_SJ8R1XarpLCjj4	website	2026-02-22 09:03:32.681847+00	2026-02-28 05:25:05.284834+00	0	0	3500.00	420.00	12.00	Deulex room
33	4	2026-02-22	2026-02-24	2	Sahil	dhanawade	jaydhanawade4848@gmail.com	8983784848		7840.00	confirmed	paid	razorpay	order_SJ8Rqq9Y3e5nGP	pay_SJ8S3jRStDO96G	website	2026-02-22 09:04:27.174694+00	2026-02-28 05:25:05.284834+00	0	0	7000.00	840.00	12.00	Deulex room
35	5	2026-02-27	2026-02-28	2	Yash	Karanjule	yashkaranjule230@gmail.com	9604269875		5040.00	confirmed	paid	razorpay	order_SL6QDL9L1nAfVu	pay_SL6QP8bovIkLBM	website	2026-02-27 08:23:41.480919+00	2026-02-28 05:25:05.284834+00	0	0	4500.00	540.00	12.00	Valley Room
37	\N	2026-02-28	2026-03-01	2	Yash	Karanjule	yashkaranjule230@gmail.com	9604269875		6048.00	confirmed	paid	razorpay	order_SLS4faCmjMeEZK	pay_SLS4swhGLVK63R	website	2026-02-28 05:34:23.67406+00	2026-02-28 05:34:40.508958+00	0	0	5400.00	648.00	12.00	\N
\.
...
1	mail_username	grandvalleyresortsbhilar@gmail.com	SMTP username/email	2026-02-27 11:12:20.783126+00
2	mail_password	jogsnrfcxbknfeag	SMTP password/app password	2026-02-27 11:12:21.380312+00
3	mail_server	smtp.gmail.com	SMTP server address	2026-02-27 11:12:21.977551+00
4	mail_port	587	SMTP port number	2026-02-27 11:12:22.523008+00
\.
...
--
-- Data for Name: house_rules; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: resort_closures; Type: TABLE DATA; Schema: public; Owner: -
--
...
20211116024918	2026-02-26 12:17:02
20211116045059	2026-02-26 12:17:02
20211116050929	2026-02-26 12:17:03
20211116051442	2026-02-26 12:17:04
20211116212300	2026-02-26 12:17:05
20211116213355	2026-02-26 12:17:05
20211116213934	2026-02-26 12:17:06
20211116214523	2026-02-26 12:17:07
20211122062447	2026-02-26 12:17:07
20211124070109	2026-02-26 12:17:08
20211202204204	2026-02-26 12:17:09
20211202204605	2026-02-26 12:17:09
20211210212804	2026-02-26 12:17:11
20211228014915	2026-02-26 12:17:12
20220107221237	2026-02-26 12:17:13
20220228202821	2026-02-26 12:17:13
20220312004840	2026-02-26 12:17:14
20220603231003	2026-02-26 12:17:15
20220603232444	2026-02-26 12:17:16
20220615214548	2026-02-26 12:17:16
20220712093339	2026-02-26 12:17:17
20220908172859	2026-02-26 12:17:18
20220916233421	2026-02-26 12:17:18
20230119133233	2026-02-26 12:17:19
20230128025114	2026-02-26 12:17:20
20230128025212	2026-02-26 12:17:21
20230227211149	2026-02-26 12:17:21
20230228184745	2026-02-26 12:17:22
20230308225145	2026-02-26 12:17:22
20230328144023	2026-02-26 12:17:23
20231018144023	2026-02-26 12:17:24
20231204144023	2026-02-26 12:17:25
20231204144024	2026-02-26 12:17:26
20231204144025	2026-02-26 12:17:26
20240108234812	2026-02-26 12:17:27
20240109165339	2026-02-26 12:17:27
20240227174441	2026-02-26 12:17:29
20240311171622	2026-02-26 12:17:29
20240321100241	2026-02-26 12:17:31
20240401105812	2026-02-26 12:17:33
20240418121054	2026-02-26 12:17:34
20240523004032	2026-02-26 12:17:36
20240618124746	2026-02-26 12:17:37
20240801235015	2026-02-26 12:17:37
20240805133720	2026-02-26 12:17:38
20240827160934	2026-02-26 12:17:38
20240919163303	2026-02-26 12:17:39
20240919163305	2026-02-26 12:17:40
20241019105805	2026-02-26 12:17:41
20241030150047	2026-02-26 12:17:43
20241108114728	2026-02-26 12:17:44
20241121104152	2026-02-26 12:17:45
20241130184212	2026-02-26 12:17:45
20241220035512	2026-02-26 12:17:46
20241220123912	2026-02-26 12:17:47
20241224161212	2026-02-26 12:17:47
20250107150512	2026-02-26 12:17:48
20250110162412	2026-02-26 12:17:49
20250123174212	2026-02-26 12:17:49
20250128220012	2026-02-26 12:17:50
20250506224012	2026-02-26 12:17:50
20250523164012	2026-02-26 12:17:51
20250714121412	2026-02-26 12:17:52
20250905041441	2026-02-26 12:17:52
20251103001201	2026-02-26 12:17:53
20251120212548	2026-02-26 12:17:54
20251120215549	2026-02-26 12:17:54
20260218120000	2026-02-27 18:30:16
\.
...
0	create-migrations-table	e18db593bcde2aca2a408c4d1100f6abba2195df	2026-02-26 10:51:00.644343
1	initialmigration	6ab16121fbaa08bbd11b712d05f358f9b555d777	2026-02-26 10:51:00.701745
2	storage-schema	f6a1fa2c93cbcd16d4e487b362e45fca157a8dbd	2026-02-26 10:51:00.704472
3	pathtoken-column	2cb1b0004b817b29d5b0a971af16bafeede4b70d	2026-02-26 10:51:00.746937
4	add-migrations-rls	427c5b63fe1c5937495d9c635c263ee7a5905058	2026-02-26 10:51:00.761296
5	add-size-functions	79e081a1455b63666c1294a440f8ad4b1e6a7f84	2026-02-26 10:51:00.764173
6	change-column-name-in-get-size	ded78e2f1b5d7e616117897e6443a925965b30d2	2026-02-26 10:51:00.768707
7	add-rls-to-buckets	e7e7f86adbc51049f341dfe8d30256c1abca17aa	2026-02-26 10:51:00.772463
8	add-public-to-buckets	fd670db39ed65f9d08b01db09d6202503ca2bab3	2026-02-26 10:51:00.775089
9	fix-search-function	af597a1b590c70519b464a4ab3be54490712796b	2026-02-26 10:51:00.777716
10	search-files-search-function	b595f05e92f7e91211af1bbfe9c6a13bb3391e16	2026-02-26 10:51:00.780446
11	add-trigger-to-auto-update-updated_at-column	7425bdb14366d1739fa8a18c83100636d74dcaa2	2026-02-26 10:51:00.78331
12	add-automatic-avif-detection-flag	8e92e1266eb29518b6a4c5313ab8f29dd0d08df9	2026-02-26 10:51:00.786813
13	add-bucket-custom-limits	cce962054138135cd9a8c4bcd531598684b25e7d	2026-02-26 10:51:00.789525
14	use-bytes-for-max-size	941c41b346f9802b411f06f30e972ad4744dad27	2026-02-26 10:51:00.792278
15	add-can-insert-object-function	934146bc38ead475f4ef4b555c524ee5d66799e5	2026-02-26 10:51:00.818544
16	add-version	76debf38d3fd07dcfc747ca49096457d95b1221b	2026-02-26 10:51:00.821915
17	drop-owner-foreign-key	f1cbb288f1b7a4c1eb8c38504b80ae2a0153d101	2026-02-26 10:51:00.824426
18	add_owner_id_column_deprecate_owner	e7a511b379110b08e2f214be852c35414749fe66	2026-02-26 10:51:00.826806
19	alter-default-value-objects-id	02e5e22a78626187e00d173dc45f58fa66a4f043	2026-02-26 10:51:00.843023
20	list-objects-with-delimiter	cd694ae708e51ba82bf012bba00caf4f3b6393b7	2026-02-26 10:51:00.845609
21	s3-multipart-uploads	8c804d4a566c40cd1e4cc5b3725a664a9303657f	2026-02-26 10:51:00.849828
22	s3-multipart-uploads-big-ints	9737dc258d2397953c9953d9b86920b8be0cdb73	2026-02-26 10:51:00.861828
23	optimize-search-function	9d7e604cddc4b56a5422dc68c9313f4a1b6f132c	2026-02-26 10:51:00.869708
24	operation-function	8312e37c2bf9e76bbe841aa5fda889206d2bf8aa	2026-02-26 10:51:00.873327
25	custom-metadata	d974c6057c3db1c1f847afa0e291e6165693b990	2026-02-26 10:51:00.87651
26	objects-prefixes	215cabcb7f78121892a5a2037a09fedf9a1ae322	2026-02-26 10:51:00.8793
27	search-v2	859ba38092ac96eb3964d83bf53ccc0b141663a6	2026-02-26 10:51:00.881526
28	object-bucket-name-sorting	c73a2b5b5d4041e39705814fd3a1b95502d38ce4	2026-02-26 10:51:00.883658
29	create-prefixes	ad2c1207f76703d11a9f9007f821620017a66c21	2026-02-26 10:51:00.885841
30	update-object-levels	2be814ff05c8252fdfdc7cfb4b7f5c7e17f0bed6	2026-02-26 10:51:00.887896
31	objects-level-index	b40367c14c3440ec75f19bbce2d71e914ddd3da0	2026-02-26 10:51:00.890076
32	backward-compatible-index-on-objects	e0c37182b0f7aee3efd823298fb3c76f1042c0f7	2026-02-26 10:51:00.893161
33	backward-compatible-index-on-prefixes	b480e99ed951e0900f033ec4eb34b5bdcb4e3d49	2026-02-26 10:51:00.895695
34	optimize-search-function-v1	ca80a3dc7bfef894df17108785ce29a7fc8ee456	2026-02-26 10:51:00.897705
35	add-insert-trigger-prefixes	458fe0ffd07ec53f5e3ce9df51bfdf4861929ccc	2026-02-26 10:51:00.899696
36	optimise-existing-functions	6ae5fca6af5c55abe95369cd4f93985d1814ca8f	2026-02-26 10:51:00.901842
37	add-bucket-name-length-trigger	3944135b4e3e8b22d6d4cbb568fe3b0b51df15c1	2026-02-26 10:51:00.903958
38	iceberg-catalog-flag-on-buckets	02716b81ceec9705aed84aa1501657095b32e5c5	2026-02-26 10:51:00.907665
39	add-search-v2-sort-support	6706c5f2928846abee18461279799ad12b279b78	2026-02-26 10:51:00.913864
40	fix-prefix-race-conditions-optimized	7ad69982ae2d372b21f48fc4829ae9752c518f6b	2026-02-26 10:51:00.916109
41	add-object-level-update-trigger	07fcf1a22165849b7a029deed059ffcde08d1ae0	2026-02-26 10:51:00.918465
42	rollback-prefix-triggers	771479077764adc09e2ea2043eb627503c034cd4	2026-02-26 10:51:00.920666
43	fix-object-level	84b35d6caca9d937478ad8a797491f38b8c2979f	2026-02-26 10:51:00.92291
44	vector-bucket-type	99c20c0ffd52bb1ff1f32fb992f3b351e3ef8fb3	2026-02-26 10:51:00.925154
45	vector-buckets	049e27196d77a7cb76497a85afae669d8b230953	2026-02-26 10:51:00.928671
46	buckets-objects-grants	fedeb96d60fefd8e02ab3ded9fbde05632f84aed	2026-02-26 10:51:00.941246
47	iceberg-table-metadata	649df56855c24d8b36dd4cc1aeb8251aa9ad42c2	2026-02-26 10:51:00.943951
48	iceberg-catalog-ids	e0e8b460c609b9999ccd0df9ad14294613eed939	2026-02-26 10:51:00.946153
49	buckets-objects-grants-postgres	072b1195d0d5a2f888af6b2302a1938dd94b8b3d	2026-02-26 10:51:00.958541
50	search-v2-optimised	6323ac4f850aa14e7387eb32102869578b5bd478	2026-02-26 10:51:00.961994
51	index-backward-compatible-search	2ee395d433f76e38bcd3856debaf6e0e5b674011	2026-02-26 10:51:01.79515
52	drop-not-used-indexes-and-functions	5cc44c8696749ac11dd0dc37f2a3802075f3a171	2026-02-26 10:51:01.796791
53	drop-index-lower-name	d0cb18777d9e2a98ebe0bc5cc7a42e57ebe41854	2026-02-26 10:51:01.806494
54	drop-index-object-level	6289e048b1472da17c31a7eba1ded625a6457e67	2026-02-26 10:51:01.809531
55	prevent-direct-deletes	262a4798d5e0f2e7c8970232e03ce8be695d5819	2026-02-26 10:51:01.810952
56	fix-optimized-search-function	cb58526ebc23048049fd5bf2fd148d18b04a2073	2026-02-26 10:51:01.814698
\.
...
--
-- Name: calendar_settings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: house_rules_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: resort_closures_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: social_media_links_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: calendar_settings calendar_settings_setting_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: house_rules house_rules_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: resort_closures resort_closures_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: social_media_links social_media_links_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_attractions_is_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_blocked_dates_end_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_blocked_dates_external_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_blocked_dates_room_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_blocked_dates_source; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_blocked_dates_start_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bookings_booking_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bookings_check_out_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bookings_razorpay_order_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_calendar_settings_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_features_display_order; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_house_rules_is_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_house_rules_order_num; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_resort_closures_end_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_resort_closures_is_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_resort_closures_start_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_room_images_is_primary; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_room_images_room_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_rooms_deleted; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_rooms_is_available; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_rooms_quantity; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_rooms_room_number; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_rooms_slug; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_social_media_links_display_order; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_social_media_links_is_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_testimonials_is_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_testimonials_is_featured; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tourist_attractions_category; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tourist_attractions_display_order; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tourist_attractions_is_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tourist_attractions_is_featured; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_whatsapp_messages_is_read; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_whatsapp_messages_session_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_whatsapp_sessions_guest_phone; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: blocked_dates blocked_dates_room_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: whatsapp_messages whatsapp_messages_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: attractions Allow authenticated delete; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: features Allow authenticated delete; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: attractions Allow authenticated insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: features Allow authenticated insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: attractions Allow authenticated update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: features Allow authenticated update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: attractions Allow public read access; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: features Allow public read access; Type: POLICY; Schema: public; Owner: -
--
...
\unrestrict L5ajc09a5zkiVanV2CfyEEoVUp9hkgMc9pboujNhxMqAwxfU4fIyRvzXOdnTJzV
